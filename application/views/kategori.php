...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() . 'assets/css/kategori_artikel.css' ?>">
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/image/favicon.ico" />
    <title>Olpet - Kategori Artikel</title>
</head>

<body>

    <?php $this->load->view('templates/header_anjing_2'); ?>
            ...
            <?php foreach ($artikel as $a) : ?>
                ...
                <a href="<?= base_url('olpet/detail_article/' . $a->id); ?>" style="text-decoration: none; color: unset;">
                    <div class="service">
                        ...
                        <h2><?= $a->judul; ?></h2>
                        <h4 style="margin-top: -7px; font-size: 15px; color: #fff; font-weight: lighter;"><?= $a->jenis_artikel ?></h4>
                        <h5 style="font-size: 15px; color: #fff; font-weight: lighter"><?= $a->kategori ?></h5>
